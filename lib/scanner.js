...
function detectType(projectDir) {
  ...
  // Python project with serve file
  ...
  // Swift project — CLI tools, not capturable
...
function scanDir(projectDir, name, launchMap, overrides) {
  ...
  const launchable = detected.capturable !== false && (detected.startCommand !== null || detected.type === 'html');
